// Mexican Night Color Palette
// Inspired by the vibrant lights of Mexico City at night

export const palette = {
  // ==========================================
  // BASE COLORS
  // ==========================================
  black: "#16161e",              // Updated to match nightSky
  white: "#c0caf5",
  ...
  // ==========================================
  nightSky: "#16161E",           // Darkest (main backgrounds)
  nightSkyLight: "#1E1E2E",      // Slightly lighter (editor)
  nightSkyMedium: "#2D2D3D",     // Medium (selections)
  nightSkyBright: "#3B3B52",     // Lightest (highlights)

  // ==========================================
  // TEXT COLORS (Hierarchy)
  // ==========================================
  textPrimary: "#c0caf5",        // Brightest text
  textSecondary: "#a9b1d6",      // Secondary text
  textMuted: "#828bb8",          // Muted text
  textDark: "#565f89",           // Darkest text
